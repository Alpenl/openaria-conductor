...
class ReleaseManagerTest(unittest.TestCase):
    ...
    def test_service_declares_boot_restart_and_privileged_recovery(self) -> None:
        ...
        self.assertIn("SyslogIdentifier=rp-ylx", unit)
        ...
        self.assertIn("StandardOutput=journal", recover)
        self.assertIn("StandardError=journal", recover)
        self.assertIn("SyslogIdentifier=rp-ylx-recover", recover)
    ...
    def test_data_volume_asset_uses_data_mount_and_reserved_backing_file(self) -> None:
        ...
        self.assertIn("SyslogIdentifier=rp-ylx-data-volume", service)
    ...
    def test_wifi_watchdog_assets_are_syntactically_valid_and_safely_wired(self) -> None:
        ...
        self.assertIn("StandardOutput=journal", service)
        self.assertIn("StandardError=journal", service)
        self.assertIn("SyslogIdentifier=rp-ylx-wifi-watchdog", service)
    ...
    def test_network_control_socket_is_staged_as_root_only_fail_closed_boundary(self) -> None:
        ...
        self.assertIn("StandardError=journal", service)
        self.assertIn("SyslogIdentifier=rp-ylx-network-control", service)
