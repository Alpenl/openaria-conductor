    ...
    def _audio_block(self) -> dict[str, object]:
        ...
        return {
            ...
            "sync": {
                ...
                "session_start_offset_seconds": (started_monotonic_ns - self._started_monotonic_ns)
                / 1e9,
                "session_stop_offset_seconds": (stopped_monotonic_ns - self._started_monotonic_ns)
                / 1e9,
            },
